...
@Component({
  ...
  template: `
    <div class="placeholder-page">
      <h1 class="page-title">Control de Seguimiento</h1>
      <div class="placeholder-body">
        <div class="placeholder-icon">📡</div>
        <p class="placeholder-text">Esta sección está en construcción.<br/>Aquí se gestionarán los controles de seguimiento de la flota.</p>
      </div>
    </div>
  `,
  styles: [`
