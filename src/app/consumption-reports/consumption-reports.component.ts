...
@Component({
  ...
  template: `
    <div class="placeholder-page">
      <h1 class="page-title">Reportes de Consumo</h1>
      <div class="placeholder-body">
        <div class="placeholder-icon">📊</div>
        <p class="placeholder-text">Esta sección está en construcción.<br/>Aquí se mostrarán los reportes detallados de consumo energético.</p>
      </div>
    </div>
  `,
  styles: [`
...
export class ConsumptionReportsComponent {}
